...
public class StandardKodeverk implements Kodeverk {
    ...
    public String getTelefonLand(String landkode) {
        return hentFoersteTermnavnFraKodeIKodeverk(landkode, RETNINGSNUMRE);
    }
    ...
    @Override
    public List<String> getAlleTelefonnummerLandkoder() {
        return hentAlleKodenavnFraKodeverk(RETNINGSNUMRE);
    }

    @Override
    public List<String> getAlleValuta() {
        return hentAlleKodenavnFraKodeverk(VALUTA);
    }

    @Override
    public String getValutaNavn(String valutaKey) {
        return hentFoersteTermnavnFraKodeIKodeverk(valutaKey, VALUTA);
    }
