...
import no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.MatrikkeladresseDto;
import no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.NavnDto;
import no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.OppholdsadresseDto;
...
import static no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.AdressebeskyttelseDto.Gradering.UGRADERT;
...
import static no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.SivilstandDto.SivilstandType.SKILT_PARTNER;
import static no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.SivilstandDto.SivilstandType.UGIFT;
import static no.nav.sbl.dialogarena.soknadinnsending.consumer.pdl.person.dto.SivilstandDto.SivilstandType.UOPPGITT;
