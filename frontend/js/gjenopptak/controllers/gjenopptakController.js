angular.module('nav.gjenopptak', [])
	.controller('GjenopptakCtrl', ['$scope', 'data', '$modal', function ($scope, data, $modal) {
        ...
        $scope.grupper = [
            ...
            {id: 'nyearbeidsforhold', tittel: 'nyearbeidsforhold.tittel', template: '../views/templates/arbeidsforhold/nye-arbeidsforhold.html', apen: false, skalSettesTilValidVedForsteApning: false, validering: false},
