...
angular.module("../views/templates/arbeidsforhold-nytt.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/arbeidsforhold-nytt.html",
    ...
    "                    <label for='radio5'>{{ 'arbeidsforhold.sluttaarsak.radio.sagtOppAvArbeidsgiver' | cmstekst\n" +
    "                        }}</label>\n" +
    "                </div>\n" +
    "\n" +
    "                <div class=\"nav-radio-knapp\">\n" +
    ...
    "                           data-error-messages=\"'arbeidsforhold.arbeidsgiver.sluttaarsak.feilmelding'\"\n" +
    "                           data-aktiv-feilmelding>\n" +
    "                    <label for='radio4'>{{ 'arbeidsforhold.sluttaarsak.radio.arbeidsgiverErKonkurs' | cmstekst\n" +
    "                        }}</label>\n" +
    "                </div>\n" +
    "\n" +
    "                <div class=\"nav-radio-knapp\">\n" +
    ...
    "                <div class=\"spm\" data-nav-faktum=\"sluttaarsak\" data-ikke-auto-lagre=\"true\"\n" +
    "                     data-ng-include=\"templates[faktum.properties.type].url\"></div>\n" +
    "            </div>\n" +
...
angular.module("../views/templates/arbeidsforhold.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/arbeidsforhold.html",
    ...
    "            <h4 class=\"spm-sporsmal\">{{ 'arbeidsforhold.informasjon' | cmstekst }}</h4>\n" +
    "\n" +
    "            <div data-navradio\n" +
    ...
    "                    <span>{{ 'arbeidsforhold.arbeidstilstand.fastarbeidstid.informasjonstekst' | cmstekst }}</span>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "\n" +
    "            <div data-navradio\n" +
    ...
    "                <div data-navinfoboks>\n" +
    "                    <span>{{ 'arbeidsforhold.arbeidstilstand.varierendearbeidstid.informasjonstekst' | cmstekst }}</span>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "\n" +
    "            <div data-navradio\n" +
    ...
    "                </div>\n" +
    "\n" +
    "                <button class=\"knapp-leggtil-liten\" data-ng-click=\"nyttArbeidsforhold($event, arbeidsforholdForm)\" role=\"button\"\n" +
    "                        data-aktiv-feilmelding>{{ 'arbeidsforhold.nyttarbeidsforhold' | cmstekst }}</button>\n" +
    "                <span class=\"melding\">{{ 'arbeidsforhold.arbeidsforhold.required' | cmstekst }}</span>\n" +
    "            </div>\n" +
    "\n" +
...
angular.module("../views/templates/arbeidsforhold/avskjediget.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/arbeidsforhold/avskjediget.html",
    ...
    "    <h4 class=\"spm-sporsmal\">{{ 'arbeidsforhold.arbeidsgiver.varighet.label' | cmstekst }}</h4>\n" +
...
angular.module("../views/templates/arbeidsforhold/konkurs.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/arbeidsforhold/konkurs.html",
    ...
    "    <span class=\"melding\"></span>\n" +
    "\n" +
    "    <div class=\"ekstra-spm-boks\" data-ng-if=\"sluttaarsak.properties.lonnsgaranti == 'Nei'\">\n" +
    "        <div data-navinfoboks>\n" +
...
angular.module("../views/templates/arbeidsforhold/permittert.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/arbeidsforhold/permittert.html",
    ...
    "               type=\"text\"\n" +
    "               data-ng-required=\"true\"\n" +
    "               data-error-messages=\"{required:'arbeidsforhold.sluttaarsak.permittert.permitteringsgrad.feilmelding', pattern: 'regex.tall', min: 'arbeidsforhold.sluttaarsak.permittert.forlite'}\"\n" +
    "               data-ng-pattern=\"/^\\d+$/\"\n" +
    "               data-blur-validate\n" +
    "               data-min=\"50\"\n" +
    "               maxlength=\"3\"\n" +
...
angular.module("../views/templates/barnetillegg/barnetillegg-nyttbarn.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/barnetillegg/barnetillegg-nyttbarn.html",
    ...
    "            <span>{{ 'barnetillegg.sokerbarnetillegg.tittel' | cmstekst }}</span>\n" +
    ...
    "                <div data-form-errors></div>\n" +
    "                <h2 class=\"stor-strek\">{{ 'barnetillegg.nyttbarn.tittel' | cmstekst }}</h2>\n" +
    "\n" +
    "\n" +
    "                <div data-navtekst\n" +
    "                     data-navconfig\n" +
    "                     data-navlabel=\"barnetillegg.nyttbarn.fornavn\"\n" +
    "                     data-nav-faktum-property=\"fornavn\"\n" +
    "                     data-inputfeltmaxlength=\"200\"\n" +
    "                     data-navfeilmelding=\"'barnetillegg.nyttbarn.fornavn.feilmelding'\"\n" +
    "                     data-ng-required>\n" +
    "                </div>\n" +
    "\n" +
    "                <div data-navtekst\n" +
    "                     data-navconfig\n" +
    "                     data-navlabel=\"barnetillegg.nyttbarn.etternavn\"\n" +
    "                     data-nav-faktum-property=\"etternavn\"\n" +
    "                     data-navfeilmelding=\"'barnetillegg.nyttbarn.etternavn.feilmelding'\"\n" +
    "                     data-ng-required>\n" +
    "                </div>\n" +
    "\n" +
    ...
    "\n" +
    "                    <span class=\"melding\">\n" +
    "                        {{ 'barnetillegg.nyttbarn.fodselsdato.underAtten.feilmelding' | cmstekst }}\n" +
    "                    </span>\n" +
    "                </div>\n" +
    "\n" +
    "                <div class=\"land form-linje tekstfelt\">\n" +
    ...
    "            </div>\n" +
    "\n" +
    "            <div data-ng-include=\"'../views/templates/barnetillegg/barnetilleggSporsmalTemplate.html'\"></div>\n" +
    "        </div>\n" +
    "\n" +
    "\n" +
    "        <div class=\"knapper-opprett\">\n" +
    "            <input class=\"knapp-hoved-liten\" name=\"lagre\" type=\"submit\"\n" +
    "                   value=\"{{ 'barnetillegg.nyttbarn.lagre' | cmstekst }}\"\n" +
    "                   data-ng-click=\"lagreBarn(nyttBarnForm);\">\n" +
    "\n" +
    "            <a href=\"#/soknad\" data-ng-click=\"avbrytBarnetilegg($event)\">\n" +
    "                {{ 'barnetillegg.nyttbarn.avbryt' | cmstekst }}\n" +
    "            </a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
...
angular.module("../views/templates/barnetillegg/barnetillegg.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/barnetillegg/barnetillegg.html",
    "<div class=\"skjemaramme\">\n" +
...
angular.module("../views/templates/barnetillegg/barnetilleggSporsmalTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/barnetillegg/barnetilleggSporsmalTemplate.html",
    ...
    "           data-aktiv-feilmelding>\n" +
    "    <label for=\"barnetilegg\">{{ 'barnetillegg.barnetilegg.sporsmal' | cmstekst }}</label>\n" +
    "    <span class=\"melding\">\n" +
    "        {{ 'barnetillegg.nyttbarn.barnetillegg.feilmelding' | cmstekst }}\n" +
    "    </span>\n" +
    "</div>\n" +
    "\n" +
    "<div data-ng-show=\"barnetilleggErRegistrert()\">\n" +
    "    <div data-nav-faktum-property=\"ikkebarneinntekt\"\n" +
    "         data-booleanradio\n" +
    "         data-nokkel=\"barnetillegg.barnetilegg.ikkebarneinntekt\">\n" +
    "\n" +
    "        <div data-navtekst\n" +
    "             data-navconfig\n" +
    "             data-navlabel=\"barnetillegg.barnetilegg.barneinntekttall.label\"\n" +
    "             data-navsporsmal=\"barnetillegg.barnetilegg.barneinntekttall.sporsmal\"\n" +
    "             data-nav-faktum-property=\"barneinntekttall\"\n" +
    "             data-regexvalidering=\"/^\\d+$/\"\n" +
    "             data-inputfeltmaxlength=\"200\"\n" +
    "             data-navfeilmelding=\"{required:'barnetillegg.barnetilegg.barneinntekttall.feilmelding', pattern:'barnetillegg.barnetilegg.barneinntekttall.ugyldig.feilmelding'}\"\n" +
    "             data-ng-required>\n" +
    "        </div>\n" +
    "\n" +
    "        <div data-vedlegginfoboks>\n" +
...
angular.module("../views/templates/barnetillegg/endreSystembarnTemplate.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("../views/templates/egennaering/egenNaeringvirksomhet.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/egennaering/egenNaeringvirksomhet.html",
    ...
    "       data-leggtil-orgnr>{{ 'organisasjonsnummer.leggtil' | cmstekst }}</a>\n" +
    "\n" +
...
angular.module("../views/templates/egennaering/fangstOgFiske.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/egennaering/fangstOgFiske.html",
    ...
    "     data-nav-faktum=\"egennaering.fangstogfiske\"\n" +
    "     data-navconfig\n" +
    "     data-booleanradio\n" +
...
angular.module("../views/templates/egennaering/gardsbruk.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/egennaering/gardsbruk.html",
    "<div id=\"gardsbruk\"\n" +
    "     data-nav-faktum=\"egennaering.gardsbruk\"\n" +
    "     data-navconfig\n" +
    "     data-booleanradio\n" +
    ...
    "        <div class=\"tekstfelt form-linje\" data-ng-if=\"gardseier('egennaering.gardsbruk.false.eier.jeg')\">\n" +
    "            <label>\n" +
    ...
    "            </label>\n" +
    "        </div>\n" +
    "        <div class=\"tekstfelt form-linje\" data-ng-if=\"gardseier('egennaering.gardsbruk.false.eier.ektefelle')\">\n" +
    "            <label>\n" +
    ...
    "            </label>\n" +
    "        </div>\n" +
    "        <div class=\"tekstfelt form-linje\" data-ng-if=\"gardseier('egennaering.gardsbruk.false.eier.annet')\">\n" +
    "            <label>\n" +
...
angular.module("../views/templates/feilside.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/feilside.html",
    ...
    "    <section class=\"feil-panel\" data-ng-form=\"epostForm\" data-ng-controller=\"FortsettSenereCtrl\" data-novalidate>\n" +
    "        <h1 class=\"stor-ikon-feil-gra\">{{ 'feilmelding' | cmstekst }}</h1>\n" +
    "\n" +
    "        <p>{{ 'feilmelding.innsending.1' | cmstekst }}</p>\n" +
    "\n" +
    "        <div class=\"form-linje\">\n" +
    "            <label>\n" +
    "                <span class=\"labeltekst\">{{ 'dagpenger.fortsettSenere.epost.label' | cmstekst }}</span>\n" +
    "                <input type=\"email\"\n" +
    "                       role=\"textbox\"\n" +
    "                       data-ng-model=\"epost.value\"\n" +
    ...
    "                       data-ng-required=\"true\"\n" +
    "                       data-ng-pattern=\"/^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,6}$/\"\n" +
    "                       data-blur-validate/>\n" +
    "            </label>\n" +
    "            <input type=\"submit\"\n" +
...
angular.module("../views/templates/fortsettSenere.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/fortsettSenere.html",
    "<div class=\"hvit-side\" data-panelbelyst id=\"fortsett-senere\" data-sidetittel=\"sidetittel.fortsett\">\n" +
    "	<div class=\"skjemaramme\">\n" +
    "		<div data-ng-controller=\"FortsettSenereCtrl\" data-ng-form=\"epostForm\" data-novalidate class=\"epost-input vertikal\">\n" +
    "			<h2 class=\"stor strek-ikon-soknader\">{{ 'dagpenger.fortsettSenere.tittel' | cmstekst }}</h2>\n" +
    "			<p>{{ 'dagpenger.fortsettSenere.info' | cmstekst }}</p>\n" +
    "            <div class=\"epost\">\n" +
    "                <div class=\"form-linje\">\n" +
    "                    <label>\n" +
    "                        <span class=\"labeltekst\">{{ 'dagpenger.fortsettSenere.epost.label' | cmstekst }}</span>\n" +
...
angular.module("../views/templates/informasjonsside.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/informasjonsside.html",
    ...
    "\n" +
    "<div class=\"hvit-side\" id=\"informasjonsside\" data-sidetittel=\"sidetittel.informasjon\" data-ng-cloak>\n" +
    "	<div data-panelbelyst>\n" +
    "        <div class=\"feil\" data-ng-show=\"tpsSvarerIkke()\">\n" +
    "        	<h1 class=\"utrop-sirkel-ikon\">{{ 'feilmelding' | cmstekst }}</h1>\n" +
    ...
    "\n" +
    "\n" +
    "				<div class=\"form-linje checkbox\" data-ng-if=\"oppsummering != true\" data-checkbox-validate>\n" +
    ...
    "					<input type=\"button\" class=\"knapp-hoved\" value=\"{{ 'utslagskriterier.utslag.fortsettSoknad' | cmstekst }}\" data-ng-click=\"forsettSoknadDersomBrosjyreLest()\" data-valider-informasjonsside data-fremdriftsindikator/>\n" +
    "				</div>\n" +
    "				<div data-ng-show=\"soknadErIkkeStartet()\">\n" +
    "					<input type=\"button\" class=\"knapp-hoved\" value=\"{{ 'utslagskriterier.utslag.fortsett' | cmstekst }}\" data-ng-click=\"startSoknadDersomBrosjyreLest()\" data-valider-informasjonsside data-fremdriftsindikator/>\n" +
...
angular.module("../views/templates/reellarbeidssoker/reell-arbeidssoker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/reellarbeidssoker/reell-arbeidssoker.html",
    ...
    "        <div data-form-errors></div>\n" +
    "\n" +
    "        <div data-ng-include=\"'../views/templates/reellarbeidssoker/villigDeltidTemplate.html'\"></div>\n" +
    "        <div data-ng-include=\"'../views/templates/reellarbeidssoker/villigPendleTemplate.html'\"></div>\n" +
    "        <div data-ng-include=\"'../views/templates/reellarbeidssoker/villigHelseTemplate.html'\"></div>\n" +
    "        <div data-ng-include=\"'../views/templates/reellarbeidssoker/villigjobbTemplate.html'\"></div>\n" +
    "\n" +
    "        <div data-spmblokkferdig></div>\n" +
    "    </div>\n" +
    "</div>\n" +
...
angular.module("../views/templates/reellarbeidssoker/villigDeltidTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/reellarbeidssoker/villigDeltidTemplate.html",
    ...
    "        <span>{{ 'reellarbeidssoker.villigdeltid.false.informasjon.under60' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "\n" +
    "    <div data-ng-if=\"erOver59Aar()\" data-navinfoboks>\n" +
    "        <span>{{ 'reellarbeidssoker.villigdeltid.false.informasjon.over60' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "\n" +
    ...
    "             data-navendret=\"endreDeltidsAarsaker()\"></div>\n" +
    "\n" +
    "        <div class=\"siste-element\" data-ng-if=\"harValgtAnnetUnntakDeltid()\" data-navinfoboks>\n" +
    "            <p>{{ 'reellarbeidssoker.unntak.dokumentasjon' | cmstekst }}</p>\n" +
    "        </div>\n" +
    "\n" +
    "        <span class=\"melding\">{{ 'reellarbeidssoker.villigdeltid.false.minstEnCheckboksErAvhuketForDeltid.feilmelding' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"tekstfelt form-linje arbeidsmengde-container\">\n" +
    "        <h4 class=\"spm-sporsmal\">\n" +
    "            <span data-ng-if=\"erUnder60Aar()\">{{ 'reellarbeidssoker.villigdeltid.false.informasjon2' | cmstekst }}</span>\n" +
    "            <span>{{ 'reellarbeidssoker.maksimalarbeidstid' | cmstekst }}</span>\n" +
    "        </h4>\n" +
    "        <label>\n" +
    "            <span class=\"labeltekst\">{{ 'reellarbeidssoker.maksimalarbeidstid.label' | cmstekst }}</span>\n" +
    "            <input type=\"text\"\n" +
    "                   data-ng-model=\"faktum.value\"\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div data-vedlegginfoboks data-ng-if=\"trengerUtalelseFraFagpersonellDeltid()\">\n" +
    "        <ul>\n" +
    "            <li>\n" +
    "                <span>{{ 'reellarbeidssoker.utalelsefagpersonell.vedlegginformasjon' | cmstekst }}</span>\n" +
    "            </li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "</div>");
...
angular.module("../views/templates/reellarbeidssoker/villigHelseTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/reellarbeidssoker/villigHelseTemplate.html",
    "<div class=\"helse\"\n" +
    "     data-booleanradio\n" +
    "     data-navconfig\n" +
    ...
    "\n" +
    "    <div data-navinfoboks>\n" +
    "        <span>{{ 'reellarbeidssoker.villighelse.false.vedlegginformasjon' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "\n" +
    "    <div data-navtextarea\n" +
    "         data-navconfig\n" +
    ...
    "        <ul>\n" +
    "            <li>\n" +
    "                <span>{{ 'reellarbeidssoker.kanikkealletyperarbeid.vedlegginformasjon' | cmstekst }}</span>\n" +
    "            </li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
    "</div>");
...
angular.module("../views/templates/reellarbeidssoker/villigPendleTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/reellarbeidssoker/villigPendleTemplate.html",
    ...
    "\n" +
    "    <div data-ng-if=\"erUnder60Aar()\" data-navinfoboks>\n" +
    "        <span>{{ 'reellarbeidssoker.villigpendle.false.informasjon.under60' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "    <div data-ng-if=\"erOver59Aar()\" data-navinfoboks>\n" +
    "        <span>{{ 'reellarbeidssoker.villigpendle.false.informasjon.over60' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"form-linje checkbox\" data-ng-if=\"erUnder60Aar()\" data-checkbox-validate>\n" +
    ...
    "\n" +
    "        <div data-melding>\n" +
    "            <span class=\"melding\">{{ 'reellarbeidssoker.villigpendle.false.minstEnCheckboksErAvhuketForPendle.feilmelding' | cmstekst }}</span>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    "    <div data-vedlegginfoboks data-ng-if=\"trengerUtalelseFraFagpersonellPendle()\">\n" +
    "        <ul>\n" +
    "            <li>\n" +
    "                <span>{{ 'reellarbeidssoker.utalelsefagpersonell.vedlegginformasjon' | cmstekst }}</span>\n" +
    "            </li>\n" +
...
angular.module("../views/templates/reellarbeidssoker/villigjobbTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/reellarbeidssoker/villigjobbTemplate.html",
    "<div data-booleanradio\n" +
    "     data-navconfig\n" +
    ...
    "\n" +
    "    <div data-navinfoboks>\n" +
    "        <span>{{ 'reellarbeidssoker.villigjobb.false.informasjon' | cmstekst }}</span>\n" +
    "    </div>\n" +
    "    <div class=\"sentrert\">\n" +
    "        <a href=\"#/avbryt\">{{ 'reellarbeidssoker.villigjobb.false.avbryt' | cmstekst }}</a>\n" +
    "    </div>\n" +
    "</div>");
}]);
...
angular.module("../views/templates/tilleggsopplysninger.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/tilleggsopplysninger.html",
    "<div class=\"skjemaramme\">\n" +
    "    <div data-ng-form=\"tilleggsopplysningerForm\" class=\"skjemainnhold vertikal\" data-ng-controller=\"TilleggsopplysningerCtrl\" data-valider-fritekst data-novalidate>\n" +
    "        <div data-ng-form=\"frivilligForm\" class=\"textarea-form\" data-novalidate>\n" +
    "            <div data-form-errors></div>\n" +
    "            <div id=\"frivillig-textarea\">\n" +
    "                <div data-navtextarea\n" +
    "                     data-navconfig\n" +
    "                     data-nav-faktum=\"tilleggsopplysninger.fritekst\"\n" +
...
angular.module("../views/templates/utdanning/utdanningKortvarigFlereTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/utdanning/utdanningKortvarigFlereTemplate.html",
    ...
    "</div>\n" +
    "\n" +
    "<div class=\"varighet form-linje\" data-nav-faktum=\"utdanning.kortvarigflere.varighet\"\n" +
    "     data-nav-property=\"['varighetFra', 'varighetTil']\">\n" +
    "    <h4 class=\"spm-sporsmal\">{{ 'utdanning.varighet.label' | cmstekst }}</h4>\n" +
    "    <div data-nav-dato-intervall\n" +
...
angular.module("../views/templates/utdanning/utdanningKortvarigTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/utdanning/utdanningKortvarigTemplate.html",
    ...
    "</div>\n" +
    "\n" +
    "<div class=\"varighet form-linje\" data-nav-faktum=\"utdanning.kortvarig.varighet\"\n" +
    "     data-nav-property=\"['varighetFra', 'varighetTil']\">\n" +
    "    <h4 class=\"spm-sporsmal\">{{ 'utdanning.varighet.label' | cmstekst }}</h4>\n" +
    "    <div data-nav-dato-intervall\n" +
    "         data-fra-dato=\"navproperties.varighetFra\"\n" +
...
angular.module("../views/templates/utdanning/utdanningKveldTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/utdanning/utdanningKveldTemplate.html",
    ...
    "     data-ng-required></div>\n" +
    "\n" +
    "<div class=\"varighet form-linje\" data-nav-faktum=\"utdanning.kveld.varighet\" data-nav-property=\"['varighetFra', 'varighetTil']\">\n" +
    "    <h4 class=\"spm-sporsmal\">{{ 'utdanning.varighet.label' | cmstekst }}</h4>\n" +
    "    <div data-nav-dato-intervall\n" +
    "         data-fra-dato=\"navproperties.varighetFra\"\n" +
    "         data-til-dato=\"navproperties.varighetTil\"\n" +
...
angular.module("../views/templates/utdanning/utdanningNorskTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../views/templates/utdanning/utdanningNorskTemplate.html",
    ...
    "</div>\n" +
    "\n" +
    "<div class=\"varighet form-linje\" data-nav-faktum=\"utdanning.norsk.varighet\" data-nav-property=\"['varighetFra', 'varighetTil']\">\n" +
    "    <h4 class=\"spm-sporsmal\">{{ 'utdanning.varighet.label' | cmstekst }}</h4>\n" +
    "    <div data-nav-dato-intervall\n" +
    "         data-fra-dato=\"navproperties.varighetFra\"\n" +
    "         data-til-dato=\"navproperties.varighetTil\"\n" +
...
angular.module("../js/app/directives/markup/modalsideTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/app/directives/markup/modalsideTemplate.html",
    "<div class=\"modalBoks begrensning\">\n" +
    "    <div class=\"sak-totredel\">\n" +
    "        <div class=\"panel-standard-belyst\" data-ng-transclude>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "");
...
angular.module("../js/app/directives/markup/vedlegginfoboksTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/app/directives/markup/vedlegginfoboksTemplate.html",
    ...
    "        <h5>{{ 'vedlegg.leggved' | cmstekst }}</h5>\n" +
    "        <p data-ng-transclude></p>\n" +
    "        <p class=\"lastopp\">{{ 'vedlegg.infoboks.lastopp' | cmstekst }}</p>\n" +
    "    </div>\n" +
    "</div>");
}]);
...
angular.module("../js/common/directives/booleanradio/booleanradioTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/booleanradio/booleanradioTemplate.html",
    ...
    "        <div class=\"ng-transclude nav-boolean ekstra-spm-boks\"></div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("../js/common/directives/datepicker/singleDatepickerTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/datepicker/singleDatepickerTemplate.html",
    ...
    "    <label>\n" +
    "        <span class=\"labeltekst\">{{ label | cmstekst }}</span>\n" +
    "        <span class=\"vekk\">{{ 'dato.format' | cmstekst }}</span>\n" +
    ...
    "    </label>\n" +
    "\n" +
    "    <span class=\"melding\" data-ng-if=\"harRequiredFeil()\">{{ requiredErrorMessage | cmstekst }}</span>\n" +
    "    <span class=\"melding\" data-ng-if=\"harTilDatoFeil()\">{{ 'dato.tilDato.feilmelding' | cmstekst }}</span>\n" +
    "    <span class=\"melding\" data-ng-if=\"harFormatteringsFeil()\">{{ 'dato.format.feilmelding' | cmstekst }}</span>\n" +
    "    <span class=\"melding\" data-ng-if=\"erIkkeGyldigDato()\">{{ 'dato.ikkeGyldigDato.feilmelding' | cmstekst }}</span>\n" +
    "    <span class=\"melding\" data-ng-if=\"erUloveligFremtidigDato()\">{{ 'dato.ugyldigFremtidig.feilmelding' | cmstekst }}</span>\n" +
    "</div>");
}]);
...
angular.module("../js/common/directives/melding/meldingTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/melding/meldingTemplate.html",
    "<div data-ng-if=\"skalVises()\">\n" +
...
angular.module("../js/common/directives/navinput/navtallInputTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/navinput/navtallInputTemplate.html",
    "<div class=\"tekstfelt form-linje\" >\n" +
    "    <h4 data-ng-if=\"harSporsmal()\" class=\"spm-sporsmal\">{{ navsporsmal | cmstekst }}</h4>\n" +
    "    <label>\n" +
    "        <span class=\"labeltekst\">{{ navlabel | cmstekst }}</span>\n" +
    "        <input data-ng-model=\"faktum.value\"\n" +
    "               type=\"number\"\n" +
    ...
    "               data-ng-required=\"true\"\n" +
    "               data-error-messages=\"{{ navfeilmelding }}\"\n" +
    "               data-ng-pattern=\"{{ regexvalidering }}\"\n" +
    "               data-minlength=\"{{ navminlength }}\"\n" +
    "               data-maxlength=\"{{ navmaxlength }}\"\n" +
    "               maxlength=\"{{ inputfeltmaxlength }}\"\n" +
    "               data-blur-validate\n" +
    "               data-tekstfelt-patternvalidering\n" +
    "               data-aktiv-feilmelding/>\n" +
    "        <span class=\"melding\"></span>\n" +
...
angular.module("../js/common/directives/navtextarea/navtextareaObligatoriskTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/navtextarea/navtextareaObligatoriskTemplate.html",
    ...
    "                    <span data-ng-if=\"counter < 0\">{{ 'fritekst.negativtellertekst' | cmstekst }}</span>\n" +
    "                    <span data-ng-if=\"counter >= 0\">{{ 'fritekst.tellertekst' | cmstekst }}</span>\n" +
    "                </span>\n" +
    "    </label>\n" +
    "    <span class=\"melding\"></span>\n" +
    "</div>\n" +
...
angular.module("../js/common/directives/navtextarea/navtextareaTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/navtextarea/navtextareaTemplate.html",
    ...
    "            <span class=\"tellertekst\" data-ng-class=\"{negativtekstteller: counter < 0 }\"\n" +
    "                  aria-live=\"polite\"> {{counter}} </span>\n" +
    "            <span data-ng-if=\"counter < 0\">{{ 'fritekst.negativtellertekst' | cmstekst }}</span>\n" +
    "            <span data-ng-if=\"counter >= 0\">{{ 'fritekst.tellertekst' | cmstekst }}</span>\n" +
    "        </span>\n" +
    "    </label>\n" +
    "    <span class=\"melding\">{{ 'fritekst.feilmelding' | cmstekst }}</span>\n" +
    "</div>");
}]);
...
angular.module("../js/common/directives/select/selectTemplate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../js/common/directives/select/selectTemplate.html",
    ...
    "            </span>\n" +
    "            <span data-ng-if=\"harRequiredFeil()\" class=\"melding\">{{ requiredFeilmelding | cmstekst }}</span>\n" +
    "            <span data-ng-if=\"inneholderIkkeSkrevetTekst()\" class=\"melding\">{{ ugyldigFeilmelding | cmstekst }}</span>\n" +
    "        </label>\n" +
    ...
    "                data-ng-class=\"{harFokus: harFokus(option.value)}\"></li>\n" +
    "        </ul>\n" +
    "    </div>\n" +
