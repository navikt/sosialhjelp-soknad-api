        ...
        return {
            ...
            link: function(scope) {
                ...
                scope.hvisHarArbeidet = function() {
                    scope.jobbetSammenhengendeFaktum.properties.arbeidsgivernavn = scope.cmsArgumenter.modelFaktum.value;
                ...
                scope.hvisHarJobbetMerEnn6Uker = function() {
                    return scope.jobbetSammenhengendeFaktum.value == "false" && scope.hvisHarArbeidet();
                };
            }
        };
    });