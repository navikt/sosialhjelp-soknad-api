/*
 * OBS: Vi har gjort endringer i denne filen for å tilpasse den til vårt behov. Ved oppgradering vær
 * oppmerksom på dette. Dette inkluderer også tilhørende templatefilene. Se githistorikk for detaljer.
 */
...
angular.module('ui.bootstrap.datepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .controller('DatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$timeout', '$log', 'dateFilter', 'datepickerConfig', function ($scope, $attrs, $parse, $interpolate, $timeout, $log, dateFilter, datepickerConfig) {
        ...
        var focusElement = function (event, elementSelector) {
            $timeout(function () {
                self.element.find(elementSelector || "tbody").focus();
            }, 0, false);
        };
        ...
        $scope.keydown = function (evt) {
            ...
            if ((key === 'enter' || key === 'space') && harFokusPaaDatoDel()) {
    ...
    .directive('datepickerBootstrap', function () {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '../js/common/tredjeparts/directives/datepicker/template/datepicker.html',
            scope: {
                datepickerMode: '=?',
                dateDisabled: '&'
            },
                ...
                ctrl._refreshView = function () {
                    ...
                    if (scope.showWeeks) {
                        ...
                        for (var k = 0; k < numWeeks; k++) {
                            if (weekNumber > 52) {
                                weekNumber = getISO8601WeekNumber(scope.rows[k][0].date);
                            }
        ...
        function ($compile, $parse, $document, $position, dateFilter, dateParser, datepickerPopupConfig) {
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    var popupEl = angular.element('<div data-datepicker-popup-wrap><div data-datepicker-bootstrap></div></div>');
                    popupEl.attr({
                        'ng-model': 'date',
                    ...
                    var documentClickBind = function (event) {
                        if (eventTargetErIkkeDetteElementet(event)) {
                    ...
                    scope.$watch('isOpen', function (value) {
                        if (value) {
                            ...
                            scope.$broadcast('datepicker.tilbakestillGUI', scope.opprinneligDato);
                    ...
                    scope.close = function () {
                        scope.isOpen = false;
                        element.closest(".input-group").find(".apne-datepicker")[0].focus();
                    };
    ...
    .directive('datepickerPopupWrap', function () {
        return {
            ...
            replace: true,
            transclude: true,
            templateUrl: '../js/common/tredjeparts/directives/datepicker/template/popup.html',
