...
- `schema` _(default: `DEFAULT_SAFE_SCHEMA`)_ - specifies a schema to use.
  - `FAILSAFE_SCHEMA` - only strings, arrays and plain objects:
    http://www.yaml.org/spec/1.2/spec.html#i***REMOVED***6
  - `JSON_SCHEMA` - all JSON-supported types:
    http://www.yaml.org/spec/1.2/spec.html#i***REMOVED***1
  - `CORE_SCHEMA` - same as `JSON_SCHEMA`:
    http://www.yaml.org/spec/1.2/spec.html#i***REMOVED***3
...
!!int
  "binary"      => "0b1", "0***REMOVED***", "0b***REMOVED***10"
  "octal"       => "01", "052", "016172"
  "decimal"     => "1", "42", "7290"
