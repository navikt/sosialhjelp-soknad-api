...
package com.hurlant.crypto.hash
{
 	...
 	public class MD5 implements IHash
	{
		...
		private function core_md5(x:Array, len:uint):Array {
		  ...
		  var a:uint = 0***REMOVED***01; // 1732584193;
		  var b:uint = 0xEFCDAB89; //-271733879;
		  var c:uint = 0x98BADCFE; //-1732584194;
		  var d:uint = 0***REMOVED***76; // 271733878;
		  ...
		  for(var i:uint = 0; i < x.length; i += 16)
		  {
		    ...
		    c = ff(c, d, a, b, x[i+ 2], 17, 0***REMOVED***DB);
		    b = ff(b, c, d, a, x[i+ 3], 22, 0xC1BDCEEE);
		    a = ff(a, b, c, d, x[i+ 4], 7 , 0xF57C0FAF);
		    d = ff(d, a, b, c, x[i+ 5], 12, 0x4787C62A);
		    c = ff(c, d, a, b, x[i+ 6], 17, 0x***REMOVED***3);
		    b = ff(b, c, d, a, x[i+ 7], 22, 0xF***REMOVED***);
		    a = ff(a, b, c, d, x[i+ 8], 7 , 0***REMOVED***D8);
		    d = ff(d, a, b, c, x[i+ 9], 12, 0x8B44F7AF);
		    c = ff(c, d, a, b, x[i+10], 17, 0xFFFF5BB1);
		    b = ff(b, c, d, a, x[i+11], 22, 0x895CD7BE);
		    a = ff(a, b, c, d, x[i+12], 7 , 0x6***REMOVED***);
		    d = ff(d, a, b, c, x[i+13], 12, 0xF***REMOVED***);
		    c = ff(c, d, a, b, x[i+14], 17, 0x***REMOVED***E);
		    ...
		    d = gg(d, a, b, c, x[i+10], 9 ,  0***REMOVED***3);
		    ...
		    a = ii(a, b, c, d, x[i+ 0], 6 , 0x***REMOVED***4);
		    ...
		    c = ii(c, d, a, b, x[i+ 6], 15, 0x***REMOVED***4);
