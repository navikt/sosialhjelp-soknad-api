...
package com.hurlant.crypto.tests
{
	...
	public class DESKeyTest extends TestCase
	{
		...
		public function testECB():void {
			var keys:Array = [
			"3***REMOVED***1520f75e", // grabbed from the output of some js implementation out there
			"10316E028C8F3B4A", // appendix A vector
			"***REMOVED***10101", // appendix B Table 1, round 0
			"***REMOVED***10101", // round 1
			"***REMOVED***10101", // 2
			"***REMOVED***10101", 
			"***REMOVED***10101",
			"***REMOVED***10101",
			"***REMOVED***10101",
			"***REMOVED***10101",
			"***REMOVED***10101", // round 8
			"80***REMOVED***101", // app B, tbl 2, round 0
			"40***REMOVED***101",
			"20***REMOVED***101",
			"10***REMOVED***101",
			"08***REMOVED***101",
			...
			"02***REMOVED***101",
			"0180***REMOVED***1",
			"0140***REMOVED***1", // round 8
			 ];
			var pts:Array = [
			"***REMOVED***00000", // js
			"***REMOVED***00000", // App A
			"8***REMOVED***0000", // App B, tbl 1, rnd0
			"4***REMOVED***0000",
			"***REMOVED***00000",
			"1***REMOVED***0000",
			"***REMOVED***00000", // rnd 4
			...
			"0***REMOVED***0000",
			"***REMOVED***00000",
			"0***REMOVED***0000", // round 8
			"***REMOVED***00000", // App B, tbl2, rnd0
			"***REMOVED***00000",
			"***REMOVED***00000",
			"***REMOVED***00000",
			"***REMOVED***00000",
