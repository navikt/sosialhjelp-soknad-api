	...
	public class CFBModeTest extends TestCase
	{
		...
		public function testCFB_AES128():void {
			...
			var ct:ByteArray = Hex.toArray(
				"3b3fd92eb72da***REMOVED***49f8e83cfb4a" + 
				"c8a64537a0b3a93fcde3cdad9f1ce58b" + 
				"26751f67a3cbb140b1808cf187a4f4df" + 
				"c04b05357c5d1c0eeac4c66f9ff7f2e6");
			var cfb:CFBMode = new CFBMode(new AESKey(key), new NullPad);
			cfb.IV = Hex.toArray("***REMOVED***5060708090a0b0c0d0e0f");
		...
		public function testCFB_AES192():void {
			...
			var ct:ByteArray = Hex.toArray(
				...
				"67ce7f7***REMOVED***21961a2b70171d3d7a" + 
		...
		public function testCFB_AES256():void {
			...
			var pt:ByteArray = Hex.toArray(
				...
				"f69f2445df4f9b17ad2b417be66c3710");
			var ct:ByteArray = Hex.toArray(
				"dc7e84bfda79164b7ec***REMOVED***5d3860" + 
				"39ffed143b28b1***REMOVED***c6331e5407b" + 
				"d***REMOVED***15e54b92a13ed0a8267ae2f9" + 
				"75***REMOVED***ab9ce***REMOVED***23d55b1e471");
			var cfb:CFBMode = new CFBMode(new AESKey(key), new NullPad);
			cfb.IV = Hex.toArray("***REMOVED***5060708090a0b0c0d0e0f");
			var src:ByteArray = new ByteArray;
			src.writeBytes(pt);
