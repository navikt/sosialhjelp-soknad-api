...
package com.hurlant.crypto.tests
{
	...
	public class CFB8ModeTest extends TestCase
	{
		...
		public function testCFB8_AES128():void {
			...
			var pt:ByteArray = Hex.toArray("6bc1bee22e409f96e93d7***REMOVED***172aae2d");
			...
			cfb8.IV = Hex.toArray("***REMOVED***5060708090a0b0c0d0e0f");
		...
		public function testCFB8_AES256():void {
			...
			var pt:ByteArray = Hex.toArray("6bc1bee22e409f96e93d7***REMOVED***172aae2d");
			var ct:ByteArray = Hex.toArray("dc1f1a8520a64db55fcc8a***REMOVED******REMOVED***");
			var cfb8:CFB8Mode = new CFB8Mode(new AESKey(key), new NullPad);
			cfb8.IV = Hex.toArray("***REMOVED***5060708090a0b0c0d0e0f");
			var src:ByteArray = new ByteArray;
			src.writeBytes(pt);
