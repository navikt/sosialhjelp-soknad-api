...
* **deps:** update chokidar ([26792e44](http://github.com/karma-runner/karma/commit/26792e44c32e39c14e8e90***REMOVED***38adbd85dae), closes [#867](http://github.com/karma-runner/karma/issues/867))
...
* **config:**
  * ignore empty string patterns ([c***REMOVED***](http://github.com/karma-runner/karma/commit/c***REMOVED***2fb66c66245c5f00ddde3a576ddca1d2))
  * apply CLI logger options as soon as we can ([6a02056c](http://github.com/karma-runner/karma/commit/6a02056c***REMOVED***11abfb4816d39f5f583fda9a4))
...
* **browser:** reply "start" event ([8c1feae1](http://github.com/karma-runner/karma/commit/8c1feae1c0***REMOVED***65ca977fcf96640da449bee))
...
* **config:** log if no config file is specified ([27a07912](http://github.com/karma-runner/karma/commit/27***REMOVED***f5adcc0478b6006ee69d3323faa4431))
...
* **static:** Use full height for the iFrame. Fix based on PR #714. ([ca98f3a4](http://github.com/karma-runner/karma/commit/ca98f3a4eafaf9aa3***REMOVED***64d108ffa49bc9e3))
* **watcher:**
  * ignore double "add" events ([8a55901b](http://github.com/karma-runner/karma/commit/8a55901b***REMOVED***b3a747be7c36b2dd6f6dd9923))
  * improve watching efficiency ([1e4a66d3](http://github.com/karma-runner/karma/commit/1e4a66d33aeaec7900baee***REMOVED***9b9cbc3e535), closes [#616](http://github.com/karma-runner/karma/issues/616))
...
* buffer result messages when polling ([c4ad6970](http://github.com/karma-runner/karma/commit/c4a***REMOVED***03110a066ae1d9652af69e42434c6b))
* allow browser to reconnect during the test run ([cbe2851b](http://github.com/karma-runner/karma/commit/cbe2851baa55312f00be420***REMOVED***3***REMOVED***66), closes [#82](http://github.com/karma-runner/karma/issues/82), [#590](http://github.com/karma-runner/karma/issues/590))
...
* **cli:** Always pass an instance of fs to processArgs. ([06532b70](http://github.com/karma-runner/karma/commit/06532***REMOVED***1f270c227a1a7f859f2dab5afac1), closes [#677](http://github.com/karma-runner/karma/issues/677))
* **init:** set default filename ([34d49b13](http://github.com/karma-runner/karma/commit/34d49b138f3bee8f17e1e9***REMOVED***d82887f906b), closes [#680](http://github.com/karma-runner/karma/issues/680), [#681](http://github.com/karma-runner/karma/issues/681))
...
* **config:** default config can be karma.conf.js or karma.conf.coffee ([d4a06f29](http://github.com/karma-runner/karma/commit/d4a06f296c4d805f2dccd85***REMOVED***6593af4d66))
* **runner:**
...
* basic bash/zsh completion ([9dc1cf6a](http://github.com/karma-runner/karma/commit/9dc1cf6a6***REMOVED***fed6c79c4896c71af8af1953))
* **runner:** allow passing changed/added/removed files ([***REMOVED***d](http://github.com/karma-runner/karma/commit/***REMOVED***de1295f3e1e58338a8eca2b60f99175c3))
* **watcher:** make the batching delay configurable ([f***REMOVED***](http://github.com/karma-runner/karma/commit/f***REMOVED***a0fff981f11182c17ba6979dccca1105))
...
if you are using `karma run` with custom `--runer-port`, please change that to `--port`.
 ([ca4c4d88](http://github.com/karma-runner/karma/commit/ca4c4d88b9a4a1992f7975aa32b37***REMOVED***847b))
...
* detect a full page reload, show error and recover ([15d80f47](http://github.com/karma-runner/karma/commit/15d80f47***REMOVED***e9b0d54aeddf49b9aa9afe8aa), closes [#27](http://github.com/karma-runner/karma/issues/27))
...
* **init:** generate config with the new syntax ([6b27fee5](http://github.com/karma-runner/karma/commit/6b27fee5a43a7d02***REMOVED***f62fe5105b4966c43))
...
* **watcher:** ignore fs.stat errors ([74ccc9a8](http://github.com/karma-runner/karma/commit/74ccc9a8017f869bd7bbb***REMOVED***5964110a7073))


#### Features

* capture window.alert ([284c4f5c](http://github.com/karma-runner/karma/commit/284c4f5c9***REMOVED***f***REMOVED***a00d72ba5c54e433))
* ship html2js preprocessor as a default plugin ([37ecf416](http://github.com/karma-runner/karma/commit/37ecf41600a9b255ab3d57327cc83***REMOVED***42f5))
* fail if zero tests executed ([5670415e](http://github.com/karma-runner/karma/commit/5670415ecdc5e54902b479c78df5c3***REMOVED***e5c), closes [#468](http://github.com/karma-runner/karma/issues/468))
* **launcher:** normalize quoted paths ([f2155e0c](http://github.com/karma-runner/karma/commit/f2155e0***REMOVED***8c0fb95791e56***REMOVED***77a865), closes [#491](http://github.com/karma-runner/karma/issues/491))
* **web-server:** serve css files ([4***REMOVED***](http://github.com/karma-runner/karma/commit/4***REMOVED***ddf2726c1fe65c46efd5e7c1045ac041), closes [#431](http://github.com/karma-runner/karma/issues/431))
...
* **launcher:** better errors when loading launchers ([504e848c](https://github.com/karma-runner/karma/commit/504e848cf66***REMOVED***fa72e07f5337ae2d6e35b5))
* **preprocessor:**
  * do not show duplicate warnings ([47c641f7](https://github.com/karma-runner/karma/commit/47c641f7560d28e0d9eac7a***REMOVED***d296d5b628))
  * better errors when loading preprocessors ([3390a00b](https://github.com/karma-runner/karma/commit/3390a00b49c513a6da60***REMOVED***62118436130f8))
* **reporter:** better errors when loading reporters ([c645c060](https://github.com/karma-runner/karma/commit/c645c060c4***REMOVED***c2005eefe5b3a7bfa63cdcc))


#### Features

* **config:** pass the config object rather than a wrapper ([d2a3c854](https://github.com/karma-runner/karma/commit/d2a3c8546dc4b10b***REMOVED***7a1***REMOVED***39f3730))


#### Breaking Changes

* please update your karma.conf.js as follows ([d2a3c854](https://github.com/karma-runner/karma/commit/d2a3c8546dc4b10b***REMOVED***7a1***REMOVED***39f3730)):
...
* **launcher:**
  * ignore exit code when killing/timeouting ([1029bf2d](https://github.com/karma-runner/karma/commit/1029bf2d7d3d22986aa41439d2c***REMOVED***0f4dbd), closes [#444](https://github.com/karma-runner/karma/issues/444))
...
* **client:** capture all `console.*` log methods ([683e6dcb](https://github.com/karma-runner/karma/commit/683e6dcb9132de3caee39c809b5b58ef***REMOVED***4))
* **config:**
  ...
  * allow configurable launchers, preprocessors, reporters ([76bdac16](https://github.com/karma-runner/karma/commit/76bdac1681***REMOVED***648f5a76b4a9d96c7a5ef20), closes [#317](https://github.com/karma-runner/karma/issues/317))
  * add warning if old constants are used ([7233c5fb](https://github.com/karma-runner/karma/commit/7233c5fb9e1***REMOVED***000bbcb9afaddf72ccbc97))
...
* **helper:** improve useragent detection ([eb58768e](https://github.com/karma-runner/karma/commit/eb58768e32baf13b45***REMOVED***3d7ef45798ffb27))
* **init:**
  * generate coffee config files ([***REMOVED***7](https://github.com/karma-runner/karma/commit/***REMOVED***76c1d866a11249d626a75440***REMOVED***ce))
  * improve the questions a bit ([baecadb2](https://github.com/karma-runner/karma/commit/baecadb2f1a8f31c233edacafb1f8a4b736ea243))
* **proxy:** add https proxy support ([be878dc5](https://github.com/karma-runner/karma/commit/be878dc545a0dd266***REMOVED***7c976ce70f1a095c))
...
* **config:**
  ...
  * ensure basePath is always resolved ([2e5c5aaa](https://github.com/karma-runner/karma/commit/2e5c5aaaddc4ad4e1ee9c8fa0388***REMOVED***7f403))


#### Features

* allow inlined plugins ([3034bcf9](https://github.com/karma-runner/karma/commit/3034bcf9b074b693afab9***REMOVED***46d6f305d0c0))
* **debug:** show skipped specs and failure details in the console ([42ab936b](https://github.com/karma-runner/karma/commit/42ab936***REMOVED***faa8ab0ee76a6278fb3aff7fa2))
...
* **init:** to not give false warning about missing requirejs ([562607a1](https://github.com/karma-runner/karma/commit/562607a16221b256c6e92a***REMOVED***4aac88eec8d))
...
* **config:**
  * Check if configFilePath is a string. Fixes #447. ([98724b6e](https://github.com/karma-runner/karma/commit/98724b6ef5a6ba60d487e7***REMOVED***832c6ca9d8c))
  * do not change urlRoot even if proxied ([8c138b50](https://github.com/karma-runner/karma/commit/8c138***REMOVED***a3aeb230b71e1049aa60ee46905d))
* **coverage:** always send a result object ([62c3c679](https://github.com/karma-runner/karma/commit/62c3***REMOVED***9f8f82f8a2ca5646aa424eeb28842), closes [#365](https://github.com/karma-runner/karma/issues/365))
* **init:**
  * generate plugins and frameworks config ([17798d55](https://github.com/karma-runner/karma/commit/17798d55988d61070f2b9***REMOVED***17208f2b497e))
  * fix for failing "testacular init" on Windows ([0b5b3853](https://github.com/karma-runner/karma/commit/0b5***REMOVED***f13ac8f29fa6e591a8634eefa04ab7))
...
* display the version when starting ([39617395](https://github.com/karma-runner/karma/commit/396173952addce3f6***REMOVED***686a42b102aa53f8), closes [#391](https://github.com/karma-runner/karma/issues/391))
...
* allow plugins ([125ab4f8](https://github.com/karma-runner/karma/commit/125ab4f88a7cf49fd7df32264***REMOVED***7e2326ca))
* **config:**
  * always ignore the config file itself ([103bc0f8](https://github.com/karma-runner/karma/commit/103bc0f878***REMOVED***0c8a8afce0a3fbf8a516ea7))
...
* **web-server:** allow custom file handlers and mime types ([2df88287](https://github.com/karma-runner/karma/commit/2d***REMOVED***2041fd09c0b45d6a62eb***REMOVED***6589))
...
* **config:** do not change urlRoot even if proxied ([1be1ae1d](https://github.com/karma-runner/karma/commit/1be1ae1dc7ff7314f4a***REMOVED***5cb39d31362f14))
* **coverage:** always send a result object ([2d210aa6](https://github.com/karma-runner/karma/commit/2d210a***REMOVED***1f2eba05de58a696***REMOVED***5c88), closes [#365](https://github.com/karma-runner/karma/issues/365))
...
* **adapter.requirejs:** do not configure baseUrl automatically ([63f3f409](https://github.com/karma-runner/karma/commit/63f3f409ae85***REMOVED***6a7ed6537bedfe4437cb3), closes [#291](https://github.com/karma-runner/karma/issues/291))
...
* **reporter.junit:** Add browser log output to JUnit.xml ([***REMOVED***a](https://github.com/karma-runner/karma/commit/***REMOVED***a4d8fd95b8c0250ee83c23ada25d026b9), closes [#302](https://github.com/karma-runner/karma/issues/302))


#### Features

* add Teamcity reporter ([03e700ae](https://github.com/karma-runner/karma/commit/03e700ae2234ca7ddb8***REMOVED***3e3b0c80868bbd))
* **adapter.jasmine:** remove only last failed specs anti-feature ([435bf72c](https://github.com/karma-runner/karma/commit/435bf72cb***REMOVED***c8114fbaa19f9de38531), closes [#148](https://github.com/karma-runner/karma/issues/148))
* **config:** allow empty config file when called programmatically ([f3d77424](https://github.com/karma-runner/karma/commit/f3***REMOVED***09f621e1fb9d60eeec7f052ebb3c585), closes [#358](https://github.com/karma-runner/karma/issues/358))
...
* **proxy:** fix crashing proxy when browser hangs connection ([1c78a01a](https://github.com/karma-runner/karma/commit/1c78a01a19411accb86f0bde9e040***REMOVED***2575))
...
* update dependencies to the latest ([93f96278](https://github.com/karma-runner/karma/commit/93***REMOVED***7f2d5d9446d***REMOVED***0ca85cfa7df7f), [e34d8834](https://github.com/karma-runner/karma/commit/e34d8834d69ec4e022fcd6e1be4055add96d693c))
...
* **init:** fix logger configuration ([557922d7](https://github.com/karma-runner/karma/commit/557922d71941e0929f9cdc0***REMOVED***4a1f27b311))
...
* **reporter.dots:** only add newline to message when needed ([dbe1155c](https://github.com/karma-runner/karma/commit/dbe1155cb57fc4caa792f83***REMOVED***38db0fc7e0)

#### Features

* add "debug" button to easily open debugging window ([da85aab9](https://github.com/karma-runner/karma/commit/da85aab927edd1614e4e05b136de***REMOVED***aa3cb))
* **config:** support running on a custom hostname ([b8c5fe85](https://github.com/karma-runner/karma/commit/b8c5fe8533b13fd59cbf48972***REMOVED***9a84ae5b))
* **reporter.junit:** add a 'skipped' tag for skipped testcases ([6286406e](https://github.com/karma-runner/karma/commit/6286406e0a36a61125ea16d6f49b***REMOVED***64cb0), closes [#321](https://github.com/karma-runner/karma/issues/321))
