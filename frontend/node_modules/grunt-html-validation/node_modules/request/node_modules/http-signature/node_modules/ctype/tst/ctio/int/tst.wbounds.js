...
var cases = [
	...
	{ func:
	function () {
		mod_ctio.wsint32(0***REMOVED***00, 'big', tb, 0);
	}, test: '+int32_t' },
	{ func:
	function () {
		mod_ctio.wsint32(-0***REMOVED***01, 'big', tb, 0);
	}, test: '-int32_t' },
	{ func:
	function () {
		mod_ctio.wsint64([ 0***REMOVED***00, 0 ], 'big', tb, 0);
	}, test: '+int64_t' },
	{ func:
	function () {
		mod_ctio.wsint64([ -0***REMOVED***00, -1 ], 'big', tb, 0);
	}, test: '-int64_t' }
];
