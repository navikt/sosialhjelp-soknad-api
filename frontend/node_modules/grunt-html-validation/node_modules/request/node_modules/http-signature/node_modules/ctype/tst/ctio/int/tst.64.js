...
function testRead()
{
	...
	ASSERT.equal(-0***REMOVED***dc, res[0]);
	...
	data.fill(0x00);
	res = mod_ctype.rsint64(data, 'big', 0);
	ASSERT.equal(0***REMOVED***00, res[0]);
	ASSERT.equal(0***REMOVED***00, res[1]);
	res = mod_ctype.rsint64(data, 'big', 1);
	ASSERT.equal(0***REMOVED***00, res[0]);
	ASSERT.equal(0***REMOVED***00, res[1]);
	res = mod_ctype.rsint64(data, 'big', 2);
