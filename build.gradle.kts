...
object Versions {
    ...
    const val flyway = "10.0.1" // Husk å oppdatere plugin også
...
plugins {
    ...
    id("org.springframework.boot") version "3.1.5" // sjekk versjon på dependency ved endring
    id("org.flywaydb.flyway") version "10.0.1" // sjekk versjon på dependency ved endring
...
dependencies {
    ...
    // På Windows feiler det for versjon < 2.0.1
    // Ved oppgradering av token-validation-spring-test (over) - Sjekk versjon
