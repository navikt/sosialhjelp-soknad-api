...
public class DigisosApiServiceTest {
    ...
    public void testHentKommuneInfo() {
        System.setProperty("integrasjonsid_fiks", "c4bf2682-327f-4535-a087-c248d35978e1");
        System.setProperty("integrasjonpassord_fiks", "ULoREc._K5dROlKuM@^.Y_)ewL9xPg4i-ujGhhS0~m@oWMz2Y-");

        KommuneStatus kommuneInfos = digisosApiService.kommuneInfo("0105");
        System.out.println(kommuneInfos);
    }
