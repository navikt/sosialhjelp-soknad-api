...
public class LagringsSchedulerTest {
    ...
    public void skalLagreSoknadIHenvendelseOgSletteFraDatabase() throws InterruptedException {
        WebSoknad webSoknad = new WebSoknad().medId(1).medFodselsnummer("***REMOVED***").medBehandlingId("1").medUuid("1234").medStatus(SoknadInnsendingStatus.UNDER_ARBEID);
