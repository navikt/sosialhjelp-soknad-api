...
public class StartDatoServiceTest {

    private StartDatoService startDatoService = new StartDatoService();
    ...
    public void skalReturnereTrueDersomDetErForsteJanuar() {
        ...
        Boolean erJanuarEllerFebruar = startDatoService.erJanuarEllerFebruar();
