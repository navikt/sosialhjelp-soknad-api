...
import no.nav.sbl.sosialhjelp.pdf.HandlebarsUtils;
...
@Component
public class LegacyHentSvaralternativerHelper extends RegistryAwareHelper<String> {


    @Inject
    private NavMessageSource navMessageSource;

    private static final Logger LOG = LoggerFactory.getLogger(no.nav.sbl.sosialhjelp.pdf.helpers.LegacyHentSvaralternativerHelper.class);
    ...
    public String getNavn() {
        return "legacyHentSvaralternativer";
    }

    @Override
    public String getBeskrivelse() {
        return "LEGACY Henter svaralternativer, dersom det er flere valgmuligheter. Prøver med søknadens prefix + key, før den prøver med bare keyen. Kan sende inn parametere.";
    }
