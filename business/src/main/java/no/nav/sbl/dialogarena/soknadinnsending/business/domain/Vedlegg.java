...
public class Vedlegg {
    ...
    public Vedlegg(Long soknadId, Long faktumId, String gosysId, Status innsendingsvalg) {
    ...
    public Vedlegg(Long vedleggId, Long soknadId, Long faktumId, String gosysId, String navn, Long storrelse, Integer antallSider, String fillagerReferanse, byte[] data, Status innsendingsvalg) {
