package no.nav.sosialhjelp.soknad.consumer.pdlperson;
...
import static no.nav.sosialhjelp.soknad.consumer.pdlperson.PdlEllerPersonV1Service.FEATURE_BRUK_PDL;
