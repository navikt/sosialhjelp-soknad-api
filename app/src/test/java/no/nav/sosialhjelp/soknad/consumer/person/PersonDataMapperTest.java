package no.nav.sosialhjelp.soknad.consumer.person;
...
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.DOED;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.KODE_6;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.KODE_6_TALLFORM;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.KODE_7_TALLFORM;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.RELASJON_BARN;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.RELASJON_EKTEFELLE;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.RELASJON_REGISTRERT_PARTNER;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.erDoed;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.erMyndig;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.finnBarnForPerson;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.finnEktefelleForPerson;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.finnSivilstatus;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.mapXmlPersonTilPerson;
import static no.nav.sosialhjelp.soknad.consumer.person.PersonMapper.xmlPersonHarDiskresjonskode;
