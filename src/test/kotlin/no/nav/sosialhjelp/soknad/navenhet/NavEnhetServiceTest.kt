...
class NavEnhetServiceTest {
    ...
    internal fun `getNavEnhet - adressevalg er folkeregistrert - skal bruke kommunenummer fra GT og kommunenavn fra kodeverk`() {
        ...
        soknadUnderArbeid.jsonInternalSoknad!!
            ...
            .withFolkeregistrertAdresse(OPPHOLDSADRESSE.withAdresseValg(JsonAdresseValg.FOLKEREGISTRERT))
    ...
    companion object {
        ...
        private val SOKNADSMOTTAKER_FORSLAG_BYDEL_MARKA =
            AdresseForslag(
                null,
                null,
                null,
