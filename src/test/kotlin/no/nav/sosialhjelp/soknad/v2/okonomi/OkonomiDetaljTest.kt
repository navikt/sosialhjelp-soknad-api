...
class OkonomiDetaljTest {
    ...
    fun `Mappe liste med Belop til json og tilbake skal fungere`() {
        val okonomiDetaljer: OkonomiDetaljer<Belop> =
            OkonomiDetaljer(
                listOf(
                    Belop(belop = 40.0),
                    Belop(belop = 50.0),
        ...
        val jsonString = OkonomiskeDetaljerToStringConverter<Belop>().convert(okonomiDetaljer)
        ...
        assertThat(okonomidetaljer2.detaljer.size).isEqualTo(okonomiDetaljer.detaljer.size)
    ...
    fun `Mappe BruttoNetto til json og tilbake skal fungere`() {
        ...
        val json = OkonomiskeDetaljerToStringConverter<BruttoNetto>().convert(okonomiDetaljer)
    ...
    fun `Mappe Utbetaling til json og tilbake skal fungere`() {
        ...
        val json = OkonomiskeDetaljerToStringConverter<Utbetaling>().convert(okonomiDetaljer)
        assertThat(json).contains("50.0").contains("40.0").contains("70.0").contains("30.0")
        assertThat(okonomiDetaljer.detaljer).anyMatch { (it as Utbetaling).utbetalingsdato == now }
        assertThat(okonomiDetaljer.detaljer).anyMatch { (it as Utbetaling).periodeTom == now }
    ...
    fun `Mappe UtbetalingMedKomponenter til json og tilbake skal fungere`() {
        ...
        val json = OkonomiskeDetaljerToStringConverter<UtbetalingMedKomponent>().convert(okonomiDetaljer)
