...
internal class JsonDokumentasjonUtilsTest {
    ...
    fun addHendelseTypeAndHendelseReferanse_forSoknad() {
        val originalJsonVedleggSpesifikasjon = createJsonVedleggSpesifikasjon()
        val jsonVedleggSpesifikasjon = addHendelseTypeAndHendelseReferanse(originalJsonVedleggSpesifikasjon)
        assertThat(originalJsonVedleggSpesifikasjon.vedlegg[0].hendelseType).isNull()
        assertThat(originalJsonVedleggSpesifikasjon.vedlegg[0].hendelseReferanse).isNull()
