...
class AdresseController(
    ...
    fun updateAdresser(
        ...
        if (adresserInput.adresseValg == null && adresserInput.brukerAdresse == null) {
            throw IllegalArgumentException("adresseValg og brukerAdresse kan ikke være null samtidig")
        }
