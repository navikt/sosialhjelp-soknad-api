...
fun leggTilJuridiskInformasjon(pdf: PdfGenerator, soknad: JsonSoknad, utvidetSoknad: Boolean) {
    if (utvidetSoknad && soknad.mottaker != null && soknad.mottaker.navEnhetsnavn != null) {
        ...
        pdf.skrivTekstMedInnrykk("* Vi skal ikke innhente flere opplysninger enn det som er nødvendig.", PdfGenerator.INNRYKK_2)
        pdf.skrivTekstMedInnrykk("* NAV har taushetsplikt om alle opplysninger som vi behandler. Hvis offentlige virksomheter eller andre ønsker å få utlevert opplysninger om deg, må de ha hjemmel i lov eller du må gi samtykke til det.", PdfGenerator.INNRYKK_2)
        pdf.addBlankLine()
        ...
        urisOnPage["De registrertes rettigheter etter nytt regelverk"] = "https://www.datatilsynet.no/regelverk-og-skjema/veiledere/de-registrertes-rettigheter-etter-nytt-regelverk/"
        urisOnPage["Personvern og sikkerhet på nav.no"] = "https://www.nav.no/no/nav-og-samfunn/om-nav/personvern-i-arbeids-og-velferdsetaten/personvern-og-sikkerhet-pa-nav.no"
