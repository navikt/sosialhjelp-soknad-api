...
import no.nav.sosialhjelp.soknad.nymodell.domene.okonomi.type.InntektType.*
import no.nav.sosialhjelp.soknad.nymodell.domene.okonomi.type.SamtykkeType
...
fun SamtykkeType.toSoknadJsonType(): String {
    return when(this) {
        SamtykkeType.BOSTOTTE_SAMTYKKE -> SoknadJsonTyper.BOSTOTTE_SAMTYKKE
        SamtykkeType.UTBETALING_SKATTEETATEN_SAMTYKKE -> SoknadJsonTyper.UTBETALING_SKATTEETATEN_SAMTYKKE
    }
}
