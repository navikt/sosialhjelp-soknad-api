...
import no.nav.sosialhjelp.soknad.business.util.FileDetectionUtils.detectTikaType
import no.nav.sosialhjelp.soknad.business.util.FileDetectionUtils.getMimeType
...
class OpplastetVedleggService(
    ...
    fun saveVedleggAndUpdateVedleggstatus(
        ...
        val opplastetVedlegg = OpplastetVedlegg()
            .withEier(eier)
            .withVedleggType(VedleggType(vedleggstype))
            .withData(data)
