...
class KrrClient(
    ...
    private fun getAzureadToken() = runBlocking { texasService.getToken("azuread", krrScope) }

    private val azureToken get() = runBlocking { azureadService.getSystemToken(krrScope) }
