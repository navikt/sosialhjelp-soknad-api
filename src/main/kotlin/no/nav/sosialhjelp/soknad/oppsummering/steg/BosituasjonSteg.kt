...
object BosituasjonSteg {
    fun get(jsonInternalSoknad: JsonInternalSoknad): Steg {
        val bosituasjon = requireNotNull(requireNotNull(jsonInternalSoknad.soknad).data.bosituasjon)
        return Steg(
            stegNr = 5,
