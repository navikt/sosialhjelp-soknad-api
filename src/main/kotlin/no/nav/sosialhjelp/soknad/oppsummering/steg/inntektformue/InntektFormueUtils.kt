...
object InntektFormueUtils {
    fun harBekreftelse(opplysninger: JsonOkonomiopplysninger, type: String): Boolean {
        return opplysninger.bekreftelse != null && opplysninger.bekreftelse.any { type == it.type }
    }

    fun harBekreftelseTrue(opplysninger: JsonOkonomiopplysninger, type: String): Boolean {
    ...
    fun addFormueIfPresent(oversikt: JsonOkonomioversikt?, felter: MutableList<Felt>, type: String, key: String) {
        oversikt?.formue
