...
public class SubjectHandler {
    private static final SubjectHandler.SubjectStorage subjectStorage = new SubjectHandler.ThreadLocalSubjectStorage();
    ...
    private static class ThreadLocalSubjectStorage implements SubjectHandler.SubjectStorage {
