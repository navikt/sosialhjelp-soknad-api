...
public class FiksDokumentHelperRest {
    private static final Logger logger = getLogger(FiksDokumentHelperRest.class);
    ...
    public FiksDokumentHelperRest(boolean skalKryptere, DokumentKrypterer dokumentKrypterer, InnsendingService innsendingService, SosialhjelpPdfGenerator sosialhjelpPdfGenerator) {
    ...
    private ByteArrayInputStream krypterOgOpprettByteArrayInputStream(byte[] fil) {
        if (skalKryptere) {
