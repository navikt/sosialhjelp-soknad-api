...
import no.nav.sosialhjelp.soknad.consumer.person.domain.MidlertidigAdresseNorge;
import no.nav.sosialhjelp.soknad.consumer.person.domain.MidlertidigAdresseUtland;
import no.nav.sosialhjelp.soknad.consumer.person.domain.PersonData;
import no.nav.sosialhjelp.soknad.consumer.person.domain.PostboksadresseNorsk;
import no.nav.sosialhjelp.soknad.consumer.person.domain.StrukturertAdresse;
import no.nav.sosialhjelp.soknad.consumer.person.domain.UstrukturertAdresse;
