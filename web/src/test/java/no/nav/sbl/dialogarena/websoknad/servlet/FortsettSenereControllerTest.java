...
public class FortsettSenereControllerTest {
    ...
    public void skalKunneGenerereGjenopptaUrl() {
        Assert.assertEquals("http://a34duvw22583.devillo.no:8181/sendsoknad/utslagskriterier/dagpenger#/behandling?utm_source=web&utm_medium=email&utm_campaign=2",
    ...
    public void skalGjennoppta() throws Exception {
        ...
        verify(emailService).sendFortsettSenereEPost("test@epost.com", "Lenke til påbegynt dagpengesøknad", "test med url http://localhost:80/soknad/NAV13/BH123/fortsettsenere/utslagskriterier/dagpenger#/BH123?utm_source=web&utm_medium=email&utm_campaign=2");
    }
