...
public class ContentConfigTest {
    ...
    //@Value("${dokumentinnsending.cms.url}")
    private String cmsBaseUrl;

    private static final String DEFAULT_LOCALE = "nb";
    private static final String INNHOLDSTEKSTER_NB_NO_REMOTE = "/site/16/dokumentinnsending/nb/tekster";
    ...
    private static final String SBL_SKJEMABESKRIVELSER_NB_NO_REMOTE = "/site/16/Skjemabeskrivelser/nb/skjemabeskrivelser";
    ...
    public ValueRetriever siteContentRetriever() throws URISyntaxException {
        ...
        return new ValuesFromContentWithResourceBundleFallback(Arrays.asList(INNHOLDSTEKSTER_NB_NO_LOCAL, SBL_WEBKOMPONENTER_NB_NO_LOCAL, SBL_SKJEMABESKRIVELSER_NB_NO_LOCAL), enonicContentRetriever(),
                uris, DEFAULT_LOCALE);
    }
