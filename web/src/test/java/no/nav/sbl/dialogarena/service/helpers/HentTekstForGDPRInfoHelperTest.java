...
public class HentTekstForGDPRInfoHelperTest {
    ...
    @Ignore("Virker ikke")
    @Test
    public void testErstattTekstq() {

        String test = "{navkontor}";

        HentTekstForGDPRInfoHelper hentTekstForGDPRInfoHelper = new HentTekstForGDPRInfoHelper();
        String resultat = hentTekstForGDPRInfoHelper.erstattTekst(regex, rawtekst, replacement);
