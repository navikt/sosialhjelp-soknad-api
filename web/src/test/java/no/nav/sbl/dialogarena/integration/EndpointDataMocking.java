...
public class EndpointDataMocking {
    ...
    public static void mockSendHenvendelse() {
        ...
        Mockito.when(soknad.hentBehandlingskjede(startsWith("INNSENDTSOKNAD")))
                .thenThrow(new SoapFault("Access denied. PolicyRequest {Used attributes: Resource= HENVENDELSE, Resource= INNSENDTSOKNAD, Resource= Ekstern, Action= Read, Subject= 1000096233942}" , QName.valueOf("")));
    }
