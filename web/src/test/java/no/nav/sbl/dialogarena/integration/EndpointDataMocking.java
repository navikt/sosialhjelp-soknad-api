...
public class EndpointDataMocking {
    ...
    public static void mockSendHenvendelse() {
        ...
        Mockito.when(soknad.hentBehandlingskjede(startsWith("INNSENDTSOKNAD_2")))
                .thenThrow(new SoapFault("Access denied. PolicyRequest {Used attributes: Resource= HENVENDELSE, Resource= 1000EB02D, Resource= Ekstern, Action= Read, Subject= 1000096233942}" , QName.valueOf("")));
    }
