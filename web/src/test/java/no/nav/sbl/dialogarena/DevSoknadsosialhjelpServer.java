...
import static no.nav.sbl.dialogarena.kodeverk.FilesAndDirs.TEST_RESOURCES;
...
public class DevSoknadsosialhjelpServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        setProperty(SamlStaticSubjectHandler.SUBJECTHANDLER_KEY, SamlStaticSubjectHandler.class.getName()); // Er med pga SaksoversiktMetadataRessurs.
