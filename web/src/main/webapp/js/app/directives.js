...
angular.module('app.directives', ['app.services', 'nav.booleanradio', 'nav.cmstekster', 'nav.input', 'nav.feilmeldinger', 'nav.sporsmalferdig', 'nav.markup', 'nav.stegindikator', 'nav.autoresizetextarea', 'nav.fremdriftsindikator', 'nav.validering', 'nav.sistlagret', 'nav.select'])
