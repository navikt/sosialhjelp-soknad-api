...
import no.nav.sbl.dialogarena.websoknad.pages.felles.input.FaktumViewModel;
import no.nav.sbl.dialogarena.websoknad.pages.felles.input.radiogruppe.RadiogruppeViewModel;
...
public class SoknadViewModel extends BaseViewModel {
    ...
    public SoknadViewModel(String tabTittel, WebSoknad soknad) {
