...
public class ContentConfig {
    ...
    private static final String INNHOLDSTEKSTER_NB_NO_REMOTE = "/systemsider/dokumentinnsending/nb/tekster";
    private static final String INNHOLDSTEKSTER_NB_NO_LOCAL = "content.innholdstekster";
    private static final String SBL_WEBKOMPONENTER_NB_NO_REMOTE = "/systemsider/sbl-webkomponenter/nb/tekster";
    private static final String SBL_WEBKOMPONENTER_NB_NO_LOCAL = "content.sbl-webkomponenter";
    private static final String SBL_SKJEMABESKRIVELSER_NB_NO_REMOTE = "/systemsider/Skjemabeskrivelser/nb/skjemabeskrivelser";
    private static final String SBL_SKJEMABESKRIVELSER_NB_NO_LOCAL = "content.skjemabeskrivelser";
    private static final String SBL_VEDLEGGBESKRIVELSER_NB_NO_REMOTE = "/systemsider/Vedleggbeskrivelser/nb/vedleggbeskrivelser";
    private static final String SBL_VEDLEGGBESKRIVELSER_NB_NO_LOCAL = "content.vedleggbeskrivelser";
    ...
    public ValueRetriever siteContentRetriever() throws URISyntaxException {
        ...
        uris.put(DEFAULT_LOCALE,
                Arrays.asList(
                        ...
                        new URI(cmsBaseUrl + SBL_SKJEMABESKRIVELSER_NB_NO_REMOTE),
                        new URI(cmsBaseUrl + SBL_VEDLEGGBESKRIVELSER_NB_NO_REMOTE)
                ));
        return new ValuesFromContentWithResourceBundleFallback(
                Arrays.asList(INNHOLDSTEKSTER_NB_NO_LOCAL, SBL_WEBKOMPONENTER_NB_NO_LOCAL, SBL_SKJEMABESKRIVELSER_NB_NO_LOCAL, SBL_VEDLEGGBESKRIVELSER_NB_NO_LOCAL), enonicContentRetriever(),
                uris, DEFAULT_LOCALE);
    }
