...
public class ServicesApplicationContext {
    ...
    public Kodeverk kodeverk() {
        ...
        return new StandardKodeverk(jaxws.kodeverkSystemUser(), NORSK_BOKMAAL, optional(brukerprofilDataDirectory).map(appendPathname("kodeverkdump")));
    }
}
