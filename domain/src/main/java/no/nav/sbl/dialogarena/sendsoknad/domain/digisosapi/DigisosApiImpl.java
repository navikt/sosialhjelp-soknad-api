...
public class DigisosApiImpl implements DigisosApi {
    ...
    private static final int SENDING_TIL_FIKS_TIMEOUT = 100; // 100 millisekund (kun for test)
    ...
    private String createJws() {
        try {
            String virksomhetsSertifikatPath = System.getProperty("virksomhetssertifikat.sti", "/var/run/secrets/nais.io/virksomhetssertifikat");
