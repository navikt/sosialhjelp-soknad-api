...
import static no.nav.sbl.dialogarena.sendsoknad.domain.transformer.sosialhjelp.json.JsonOkonomiOpplysningerConverter.opplysningUtbetaling;
...
public class JsonOkonomiOpplysningerConverterTest {
    ...
    private static final String TITTEL = "Arbeidsavklaringspenger";
    ...
    public void opplysningUtbetalingFraNavReturnererTomListeForSoknadUtenUtbetalinger() {
        ...
        List<JsonOkonomiOpplysningUtbetaling> utbetalingerFraNav = opplysningUtbetaling(webSoknad);
    ...
    public void opplysningUtbetalingFraNavLagerRiktigJsonObjektForUtbetalingUtenKomponentliste() {
        final WebSoknad webSoknad = new WebSoknad().medFaktum(lagFaktumForUtbetaling(UTBETALINGSID, TITTEL, "navytelse"));
    ...
    public void opplysningUtbetalingFraNavLagerRiktigJsonObjektForToUtbetalingerMedKomponentliste() {
        final WebSoknad webSoknad = new WebSoknad()
                .medFaktum(lagFaktumForUtbetaling(UTBETALINGSID, TITTEL, "navytelse"))
                .medFaktum(lagFaktumForUtbetaling(UTBETALINGSID2, TYPE2, "navytelse"))
    ...
    public void tilUtbetalingskomponentListeLagerRiktigJsonObjektForKomponentlisteMedToKomponenter() {
        ...
        List<JsonOkonomiOpplysningUtbetalingKomponent> utbetalingskomponenter = tilUtbetalingskomponentListe(UTBETALINGSID, webSoknad.getFaktaMedKey("utbetalinger.utbetaling.komponent"));
    ...
    private Faktum lagFaktumForUtbetaling(String utbetalingsid, String type, String kildeType) {
        return new Faktum()
