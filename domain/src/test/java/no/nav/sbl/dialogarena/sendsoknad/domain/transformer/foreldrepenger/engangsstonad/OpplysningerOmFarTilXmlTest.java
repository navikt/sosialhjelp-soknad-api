...
public class OpplysningerOmFarTilXmlTest {
    ...
    public void harFodselsnummerForFar(){
        ...
        soknad.getFakta().add(new Faktum().medKey("infofar.opplysninger.personinfo").medProperty("personnummer","10101010101"));
        ...
        assertThat(resultat.getPersonidentifikator()).isEqualTo("10101010101");
    }
